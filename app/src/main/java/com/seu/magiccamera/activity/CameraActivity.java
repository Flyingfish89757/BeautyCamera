...
public class CameraActivity extends Activity {
    ...
    private void initView() {
        ...
        btn_beauty = (ImageView) findViewById(R.id.btn_camera_beauty);
        btn_filter = (ImageView) findViewById(R.id.btn_camera_filter);
        btn_back = (ImageView) findViewById(R.id.btn_camera_back);
        btn_select = (ImageView) findViewById(R.id.btn_camera_select);

        btn_beauty.setOnClickListener(btn_listener);
        btn_filter.setOnClickListener(btn_listener);
        btn_back.setOnClickListener(btn_listener);
        btn_select.setOnClickListener(btn_listener);
